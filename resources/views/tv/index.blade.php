<x-layout>
    <div class="py-8 px-10 container mx-auto">
        ...
        <div class="bg-gray-300 mt-4 p-2">
            {{ $movies->links() }}
        </div>
