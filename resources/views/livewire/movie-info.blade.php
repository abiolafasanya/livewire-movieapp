    ...
    <div class="cast border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 text-gray-100">
            ...
            <div class="grid grid-col-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                ...
                {{-- <div class="mt-8 p-3">
                    <a href="#">
                        <img src="{{ asset('img/iris.jpg') }}" alt="image 2"
                            class="hover:opacity-75 transition ease-in-out bg-blend-normal rounded">
                    </a>
                    <div class="mt-2">
                        <a href="#" class="hover:text-gray-300">
                ...
                <div class="mt-8 p-3">
                    <a href="#">
                        <img src="{{ asset('img/frost.jpg') }}" alt="image 3"
                            class="hover:opacity-75 transition ease-in-out bg-blend-normal rounded">
                    </a>
                    <div class="mt-2">
                        <a href="#" class="hover:text-gray-300">
                ...
                <div class="mt-8 p-3">
                    <a href="#">
                        <img src="{{ asset('img/cisco.jpg') }}" alt="image 4"
                            class="hover:opacity-75 transition ease-in-out bg-blend-normal rounded">
                    </a>
                    <div class="mt-2">
                        <a href="#" class="hover:text-gray-300">
                ...
                <div class="mt-8 p-3">
                    <a href="#">
                        <img src="{{ asset('img/wells.jpg') }}" alt="image 5"
                            class="hover:opacity-75 transition ease-in-out bg-blend-normal rounded">
                    </a>
                    <div class="mt-2">
                        <a href="#" class="hover:text-gray-300">
